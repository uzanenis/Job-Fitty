...
-- DropForeignKey
ALTER TABLE "PdfFile" DROP CONSTRAINT "PdfFile_userId_fkey";
...
-- AddForeignKey
ALTER TABLE "pdf_files" ADD CONSTRAINT "pdf_files_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
